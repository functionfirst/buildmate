...
Partial Class settings
    ...
    Protected Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        If RadUpload1.UploadedFiles.Count > 0 Then
            Literal1.Text = "<span style='color: #060'>Your new company logo has been uploaded.</span>"
            ...
            End If
        Else
            Literal1.Text = "<div style='display: block; color: #f00'><b>Error:</b> Please ensure your file is in .jpg or .gif formats and the file size is under 500kb.</div>"
        End If
