<%@ Page Title="How to Video's - Buildmate" Language="VB" MasterPageFile="~/common/Manager.master" AutoEventWireup="false" CodeFile="videos.aspx.vb" Inherits="videos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="breadcrumb">
        <div class="breadcrumb-container">
            <ul class="breadcrumb-list">
                <li class="active">How to Video's</li>
            </ul>
        </div>
    </div>
        ...
        <div class="tour-inner">
            <div class="tour-nav" data-tour="menu">
                ...
                <ul class="js-tour-links">
                    ...
                    <li><a href="#" data-tab="step5">5. Introduction to Projects</a></li>
                    <li><a href="#" data-tab="step6">6. Creating Projects</a></li>
                    <li><a href="#" data-tab="step7">7. How to add Build Elements to Projects</a></li>
                    <li><a href="#" data-tab="step8">8. How to add job tasks to Build Elements</a></li>
                    <li><a href="#" data-tab="step9">9. Customers</a>
                    <li><a href="#" data-tab="step10">10. Introduction to Suppliers</a></li>
                    <li><a href="#" data-tab="step11">11. How to add Suppliers to your account</a></li>
                    <li><a href="#" data-tab="step12">12. How to add Suppliers to Resources</a></li>
                    <li><a href="#" data-tab="step13">13. Introduction to adding resources</a></li>
                    <li><a href="#" data-tab="step14">14. How to add Resources to Tasks</a></li>
                    <li><a href="#" data-tab="step15">15. Settings</a>
                </ul>
            </div>
