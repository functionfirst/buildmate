<%@ Page Title="Plant Costs - BuildMate" Language="VB" MasterPageFile="~/common/Manager.master" AutoEventWireup="false" CodeFile="plant_costs.aspx.vb" Inherits="manager_resource_costs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div class="breadcrumb">
        <ul class="breadcrumb-list">
            ...
            <li class="active">Plant Costs</li>
        </ul>
    </div>
    ...
    <asp:SqlDataSource ID="resourceDataSource" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="resourceTypeId" DefaultValue="3" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
