...
Partial Class non_web_import
    ...
    Protected Sub runImport()
        Dim filename As String = "materials.txt"
        ...
        Do While Not line Is Nothing
            ...
            If IsNumeric(resourceId) Then
                ...
                For currentSupplierId = 0 To 3
                    ' 1 - unresourced. 2 - travis perkins. 3 - builder centre. 5 - screwfix
                    Select Case currentSupplierId
                        Case 1
                    ...
                    ' if there's a prodcode for this supplier
                    ' or the supplier is "unresourced" then insert a new record
                    If Len(prodCode) >= 1 Or supplierId = 1 Then
