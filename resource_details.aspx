...
<asp:Content ID="Content" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <telerik:RadAjaxManagerProxy ID="RadAjaxManagerProxy1" runat="server">
    ...
    <!-- begin add resource -->
    <div id="addResource" class="modal-window">

        <h3><a href="#" class="close">&times;</a> Adding a Resource Supplier..</h3>
            <asp:FormView
                ID="fvResourceInsert"
                runat="server"
    ...
    <div class="modal-wrapper" title="Click or press Esc to cancel"></div>    
        ...
        <div class="breadcrumb">
            <p>
                &lArr; <a href="resources.aspx" title="Resources">Resources</a>
            </p>
        </div>
    <div class="div25">
    <div class="box">
    ...
    <div class="div75r">
    <div class="box">
        <h3>Resource Suppliers</h3>
        
        <div class="boxcontent">
            <div class=" rightalign">
                <a href="#" rel="addResource" class="open_modal button create">+ Add a Resource Supplier</a>
            </div>
